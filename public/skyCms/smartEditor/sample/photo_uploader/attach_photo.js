    ...
    function html5Upload() {	
        ...
        sUploadURL= '/manager/board/editor/file/html5';    	
    	//파일을 하나씩 보내고, 결과를 받음.
...
//        var data  = '';
//        data += 'id='+document.getElementById('editor_upimage').id.value;
//        data += '&_token='+document.getElementById('editor_upimage')._token.value;
//        data += '&boardCode='+document.getElementById('editor_upimage').boardCode.value;                    
        id = 'id='+document.getElementById('editor_upimage').id.value;
        token = '&_token='+document.getElementById('editor_upimage')._token.value;
        boardCode = '&boardCode='+document.getElementById('editor_upimage').boardCode.value;                    
        var data  = {'id' : id, '_token' : token, 'boardCode' : boardCode, 'Filedata': null};
 	...
 	function callFileUploader (){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			//sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
                sUrl  : '/skyBoard/editor/file/html',        
